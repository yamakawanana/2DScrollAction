...
namespace {
  /// <summary>
  /// 敵がヒットした時の画像の横向きの分割数を定数kFirstWalkingEnemyHitXに格納する
  /// </summary>
  static const int kFirstWalkingEnemyHitX = 5;

  // <summary>
  //敵が待機している時の画像の横向きの分割数を定数kFirstWalkingEnemyIdlingXに格納する
  /// <summary>
  static const int kFirstWalkingEnemyIdlingX = 14;

  // <summary>
  //敵が歩いている時の画像の横向きの分割数を定数kFirstWalkingEnemyWalkingXに格納する
  /// <summary>
  static const int kFirstWalkingEnemyWalkingX = 16;
}

/// <summary>
/// FirstWalkingEnemyクラス
/// </summary>
class FirstWalkingEnemy : public Task {
public:
  ...
  /// <param>なし</param>
  /// <returns>なし</returns>
  FirstWalkingEnemy(Task task_id, TaskManager * task_manager);
  ...
  /// <returns>なし</returns>
  void SetIdlingGrHandle(std::array<int, kFirstWalkingEnemyIdlingX> idling_gr_handle);
  ...
  /// <returns>なし</returns>
  void SetWalkingGrHandle(std::array<int, kFirstWalkingEnemyWalkingX> walking_gr_handle);
  ...
  /// <returns>なし</returns>
  void SetHitGrHandle(std::array<int, kFirstWalkingEnemyHitX> hit_gr_handle);
...
private:
  ...
  /// 待機時の敵のグラフィックハンドル
  /// </summary>
  std::array<int, kFirstWalkingEnemyIdlingX> idling_gr_handle_;

  /// <summary>
  /// 歩行時の敵のグラフィックハンドル
  /// </summary>
  std::array<int, kFirstWalkingEnemyWalkingX> walking_gr_handle_;

  /// <summary>
  /// ヒット時の敵のグラフィックハンドル
  /// </summary>
  std::array<int, kFirstWalkingEnemyHitX> hit_gr_handle_;
  ...
  /// 累積時間（秒）
  /// </summary>
  float first_enemy_drop_accumulation_time_;
