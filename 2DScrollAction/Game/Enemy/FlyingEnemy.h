...
namespace {
  /// <summary>
  /// 敵がヒットした時の画像の横向きの分割数を定数kFlyingEnemyHitXに格納する
  /// </summary>
  static const int kFlyingEnemyHitX = 5;

  // <summary>
  //敵が飛んでいる時の画像の横向きの分割数を定数kFlyingEnemyFlyingXに格納する
  /// <summary>
  static const int kFlyingEnemyFlyingX = 7;
}

/// <summary>
/// FlyingEnemyクラス
/// </summary>
class FlyingEnemy : public Task {
public:
  ...
  /// <param>なし</param>
  /// <returns>なし</returns>
  FlyingEnemy(Task task_id, TaskManager * task_manager);
  ...
  /// <returns>なし</returns>
  void SetWalkingGrHandle(std::array<int, kFlyingEnemyFlyingX> walking_gr_handle);
  ...
  /// <returns>なし</returns>
  void SetHitGrHandle(std::array<int, kFlyingEnemyHitX> hit_gr_handle);
...
private:
  ...
  /// 歩行時の敵のグラフィックハンドル
  /// </summary>
  std::array<int, kFlyingEnemyFlyingX> walking_gr_handle_;

  /// <summary>
  /// ヒット時の敵のグラフィックハンドル
  /// </summary>
  std::array<int, kFlyingEnemyHitX> hit_gr_handle_;
  ...
  /// 累積時間（秒）
  /// </summary>
  float flying_enemys_drop_accumulation_time_;
