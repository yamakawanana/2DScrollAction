...
namespace {
  /// <summary>
  /// 敵がヒットした時の画像の横向きの分割数を定数kSecondWalkingEnemyHitXに格納する
  /// </summary>
  static const int kSecondWalkingEnemyHitX = 5;

  // <summary>
  //敵が待機している時の画像の横向きの分割数を定数kSecondWalkingEnemyIdlingXに格納する
  /// <summary>
  static const int kSecondWalkingEnemyIdlingX = 15;

  // <summary>
  //敵が歩いている時の画像の横向きの分割数を定数kSecondWalkingEnemyWalkingXに格納する
  /// <summary>
  static const int kSecondWalkingEnemyWalkingX = 10;

  // <summary>
  //カタツムリの画像の幅を定数kSnailSizeXに格納する
  /// <summary>
  static const int kSnailSizeX = 76;

  // <summary>
  //カタツムリの画像の高さを定数kSnailSizeYに格納する
  /// <summary>
  static const int kSnailSizeY = 48;
}

/// <summary>
/// SecondWalkingEnemyクラス
/// </summary>
class SecondWalkingEnemy : public Task {
public:
  ...
  /// <param>なし</param>
  /// <returns>なし</returns>
  SecondWalkingEnemy(Task task_id, TaskManager * task_manager);
  ...
  /// <returns>なし</returns>
  void SetIdlingGrHandle(std::array<int, kSecondWalkingEnemyIdlingX> idling_gr_handle);
  ...
  /// <returns>なし</returns>
  void SetWalkingGrHandle(std::array<int, kSecondWalkingEnemyWalkingX> walking_gr_handle);
  ...
  /// <returns>なし</returns>
  void SetHitGrHandle(std::array<int, kSecondWalkingEnemyHitX> hit_gr_handle);
  ...
  /// <param ="time">毎フレーム更新時間</param>
  /// <returns>なし</returns>
  void FallEnemy(float time, float limit_time);

  /// <summary>
  /// SetMove関数の宣言
  /// </summary>
  /// <param = "is_move">動き始めるかの有無</param>
  /// <returns>なし</returns>
  ...
  /// <returns>なし</returns>
  void SetStartMoveX(int start_move_x);
...
private:
  ...
  /// 待機時の敵のグラフィックハンドル
  /// </summary>
  std::array<int, kSecondWalkingEnemyIdlingX> idling_gr_handle_;

  /// <summary>
  /// 歩行時の敵のグラフィックハンドル
  /// </summary>
  std::array<int, kSecondWalkingEnemyWalkingX> walking_gr_handle_;

  /// <summary>
  /// ヒット時の敵のグラフィックハンドル
  /// </summary>
  std::array<int, kSecondWalkingEnemyHitX> hit_gr_handle_;
  ...
  /// 累積時間（秒）
  /// </summary>
  float second_enemy_drop_accumulation_time_;
  ...
  /// </summary>
  // 足元に地面かブロックがあるかの有無を受け取る変数
  /// </summary>
  bool is_ground_;

  /// <summary>
  /// プレイヤーが到達した時に敵が動き出すX位置
  /// </summary>
  int start_move_x_;
